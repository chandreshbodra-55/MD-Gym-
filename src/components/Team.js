            ...
            <div className="row">
                <div className="col-lg-3 col-md-6 mb-5">
                    <div className="card border-0 bg-secondary text-center text-white">
                        ...
                        <div className="card-body bg-secondary">
                            <h4 className="card-title">Fahim shaikh</h4>
                ...
                <div className="col-lg-3 col-md-6 mb-5">
                    <div className="card border-0 bg-secondary text-center text-white">
                        ...
                        <div className="card-body bg-secondary">
                            <h4 className="card-title">Brett Schwargnekar</h4>
                            <p className="card-text">General Trainer</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-md-6 mb-5">
                    <div className="card border-0 bg-secondary text-center text-white">
                        ...
                        <div className="card-body bg-secondary">
                            <h4 className="card-title ">Abhinav Sharma</h4>
                            <p className="card-text">Cardio  Specialist</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-md-6 mb-5">
                    <div className="card border-0 bg-secondary text-center text-white">
                        ...
                        <div className="card-body bg-secondary">
                            <h4 className="card-title ">John Scott</h4>
                            <p className="card-text">Yoga Instructor</p>
                        </div>
                    </div>
                </div>
            </div>
